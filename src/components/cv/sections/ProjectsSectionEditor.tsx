...
// Removed restrictive PROJECT_TYPES dropdown - now using freeform input
    ...
    <div className="section-editor max-w-4xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Showcase your personal and professional projects, including key achievements and technologies used.
        </p>
      </div>
      ...
      <div className="space-y-6">
        {projects.length === 0 ? (
          <div className="text-center py-12 bg-gray-50 rounded-lg">
            ...
            <p className="text-gray-600 mb-6">Add your projects to demonstrate your practical skills and experience.</p>
              <button
              type="button"
              onClick={addProject}
